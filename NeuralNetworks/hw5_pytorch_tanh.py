import torch
import numpy as np
from torch.nn import Module, ModuleList, Parameter, Tanh
...
print()
print("********** Part 3e **********")
print("Neural network with PyTorch using tanh activation function")
...
for d in depth:
    for w in width:
        ...
        # Find the test and training errors
        with torch.no_grad():
